...
# process all images in a selected folder with the defined sequence of filters. Filtered images would not be stored (save_files=False) but will be returned as a list of numpy.ndarrays (return_list = True)
